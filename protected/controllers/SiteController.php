...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
        ...
        if (Yii::app()->request->isAjaxRequest) {
        	...
        	$data['piTarget'] = number_format(   ( $revPValue / 1500 * 100 ), 2) .' %';
        	$data['pbaTarget'] = number_format(  ($revDValue / 40 * 100)  ,2).' %';
		...
		$this->render('newui',array(
                ...
                'revPVal'=>$revPValue,
                "liveAVal"=>$liveAVal,
                'piTarget'=>number_format(  ( $revPValue / 1500 * 100 )   , 2),
                'pbaTarget'=>number_format( ( $revDValue / 40 * 100 )  ,2),
			));
	}
